...
@interface IGPersonViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@end
@implementation IGPersonViewController
- (void)viewDidLoad {
    [super viewDidLoad];
    ...
    [IGPersonViewController pictureManagerIncome:62];
}
...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    IGAddEventTableViewCell * cell = [IGAddEventTableViewCell cellWithTableView:tableView];
